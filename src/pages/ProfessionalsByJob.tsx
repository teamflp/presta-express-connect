...
const ProfessionalsByJob = () => {
  ...
  const handleViewProfile = (professionalId) => {
    navigate(`/professional/${professionalId}`, { state: { professional: professionals.find(p => p.id === professionalId) } });
  };

  const handleContact = (professionalId) => {
    navigate(`/contact-professional/${professionalId}`, { state: { professional: professionals.find(p => p.id === professionalId) } });
  };
