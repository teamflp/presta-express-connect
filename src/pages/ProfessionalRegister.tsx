...
import { Mail, User, Phone, Lock, Briefcase } from 'lucide-react';
      ...
      <div className="App">
        ...
        <div className="py-16 bg-[#FDFAF7]">
          <div className="flex items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8">
            <div className="w-full max-w-md w-50% mx-auto space-y-8">
              <FormCard
              ...
              >
                ...
                {/* L'espacement vertical entre les groupes d'éléments (grille d'inputs, checkbox, button) est géré par space-y-6 */}
                <form className="space-y-6" onSubmit={handleSubmit}>
                  {/* Grille unique pour tous les champs FormInput */}
                  {/* gap-x-6 pour l'espace horizontal entre les champs côte à côte */}
                  {/* gap-y-6 pour l'espace vertical entre les rangées de champs dans la grille */}
                  <div className="grid grid-cols-1 gap-x-6 gap-y-0 sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-2">
                    ...
                    <FormInput
                        ...
                        icon={<Lock size={18} />}
                    />
                  </div> {/* Fin de la grille des inputs */}
