  ...
  return <div className="py-16 bg-background px-0 bg-zinc-100">
      <div className="container mx-auto px-4 w-100">
        ...
        <div className="text-center mt-16">
          <Link to="/domaines" className="inline-block bg-primary text-white px-8 py-3 rounded-lg hover:bg-opacity-90 transition-all duration-300 font-medium shadow-md hover:shadow-lg">
