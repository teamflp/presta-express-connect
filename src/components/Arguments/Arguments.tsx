...
function ArgumentsPresta() {
  ...
  }} className="container bg-white p-4 p-md-5 rounded-none">
            <div className="text-center">
                <h2 className="my-4 title1 fw-bold">Pourquoi choisir <span style={{
          color: '#C63E46'
        }}>Presta Express</span> ?</h2>
            ...
            <div className="flex flex-nowrap overflow-x-auto pb-4 gap-4">
                {argumentsData.map(argument => <Card className="border-0 hover-card flex-shrink-0" key={argument.id} style={{
        minWidth: '250px',
        maxWidth: '300px'
      }}>
              ...
              boxShadow: '0 4px 8px rgba(0, 0, 0, 0.05)'
                                    ...
                                    {React.createElement(argument.icon, {
                size: 32,
                style: {
                  color: '#C63E46'
                }
